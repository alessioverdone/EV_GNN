...
def find_route_endpoints(graph, min_distance=10.0, max_attempts=5000):
...
def main():
    ...
    para_fig = RouteVisualizer.plot_parallel_coordinates(
        objectives, title="Chicago EV Route Objectives"
    )
    ...
    net_fig = RouteVisualizer.plot_network(
        graph, stations, title="Chicago Road Network & EV Stations"
    )
